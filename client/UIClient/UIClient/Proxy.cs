...
namespace UIClient
{
    public class Proxy
    {
        ...
        public Action<string> SendDataResponseAction = delegate { };

        public Proxy(string hubName)
        {
            ...
            connection.On("ReceiveData", (string response) => {
                SendDataResponseAction(response);
            });
